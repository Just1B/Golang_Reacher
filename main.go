...
// reachURL opens a url with GET method and sets a custom user agent.
// If url cannot be opened, then log it to a dedicated channel.
func reachURL(url string, chFailedUrls chan string, chIsFinished chan bool) {

	log.Println("- Reaching :", url)
...
func main() {
	...
	urlsList := [9]string{
		"https://google.fr",
		"https://amazon.fr",
		"https://urldetestimpossibleareach.fr",
		"https://youtube.fr",
		"https://twitter.com",
		"https://real2me.fr",
		"https://linkedin.fr",
		"https://instagram.com",
		"https://urldetestimpossibleareach-2.fr",
	}
	...
	for _, url := range urlsList {
		go reachURL(url, chFailedUrls, chIsFinished)
	}
	...
	fmt.Println("* Could not reach these urls: ", failedUrls)
